...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.MaxAge = field.NewInt32(tableName, "max_age")
	_session.Deleted = field.NewBool(tableName, "deleted")
	_session.CreateUser = field.NewString(tableName, "create_user")
	_session.CreateTimestamp = field.NewTime(tableName, "create_timestamp")
	_session.UpdateUser = field.NewString(tableName, "update_user")
	_session.UpdateTimestamp = field.NewTime(tableName, "update_timestamp")
...
func (s *session) updateTableName(table string) *session {
	...
	s.MaxAge = field.NewInt32(table, "max_age")
	s.Deleted = field.NewBool(table, "deleted")
	s.CreateUser = field.NewString(table, "create_user")
	s.CreateTimestamp = field.NewTime(table, "create_timestamp")
	s.UpdateUser = field.NewString(table, "update_user")
	s.UpdateTimestamp = field.NewTime(table, "update_timestamp")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["max_age"] = s.MaxAge
	s.fieldMap["deleted"] = s.Deleted
	s.fieldMap["create_user"] = s.CreateUser
	s.fieldMap["create_timestamp"] = s.CreateTimestamp
	s.fieldMap["update_user"] = s.UpdateUser
	s.fieldMap["update_timestamp"] = s.UpdateTimestamp
}
