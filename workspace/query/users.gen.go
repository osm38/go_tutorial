...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CreateTimestamp = field.NewTime(tableName, "create_timestamp")
	_user.UpdateUser = field.NewString(tableName, "update_user")
	_user.UpdateTimestamp = field.NewTime(tableName, "update_timestamp")
...
func (u *user) updateTableName(table string) *user {
	...
	u.CreateTimestamp = field.NewTime(table, "create_timestamp")
	u.UpdateUser = field.NewString(table, "update_user")
	u.UpdateTimestamp = field.NewTime(table, "update_timestamp")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["create_timestamp"] = u.CreateTimestamp
	u.fieldMap["update_user"] = u.UpdateUser
	u.fieldMap["update_timestamp"] = u.UpdateTimestamp
}
